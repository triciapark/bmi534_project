...
from open_r1.trainer import QwenVLGRPOTrainer, QwenVLGRPOVLLMTrainer
...
def main(script_args, training_args, model_args):
    ...
    trainer_cls = QwenVLGRPOTrainer if not training_args.use_vllm else QwenVLGRPOVLLMTrainer
